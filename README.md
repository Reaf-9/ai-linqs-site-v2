...
- `assets/seq/pc/f0001〜f0150.jpg`（1440×810）／`assets/seq/sp/`（608×1080、中央を 9:16 で切り出し）… 背景映像の連番。3本の5秒クリップ（①→②／②→③／③→④）を 50 枚ずつつなげたもの
- `assets/` … そのほかの画像
...
| `works-01〜04.jpg`（1200×900） | 旧構成（Works の写真グリッド）の名残。未使用 |
...
- [ ] Works に実際の写真（現場・納品物）を載せるか判断（現在は写真なし）
